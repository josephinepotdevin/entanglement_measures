...
def main():
    ...
    # Plotting
    if not args.no_plot and args.N >= 12:
        ...
        ax4.plot(t_values, results["neg_6v6"], label=r'$\epsilon_{6v6}$', color=colors[0])
        ax4.plot(t_values, results["S_01"], label=r'$S_{6v6}$', color=colors[1])
